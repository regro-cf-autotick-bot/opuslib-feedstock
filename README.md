...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opuslib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13378&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opuslib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opuslib` can be installed with:

```
conda install opuslib
```

It is possible to list all of the versions of `opuslib` available on your platform with:
